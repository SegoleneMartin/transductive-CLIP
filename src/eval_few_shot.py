...
from src.datasets import Tasks_Generator_few_shot, SamplerSupport_few_shot, SamplerQuery_few_shot, CategoriesSampler_few_shot, build_data_loader
...
class Evaluator_few_shot:
    ...
    def get_method_builder(self, model, device, args, log_file):
        ...
        if args.name_method == 'EM_DIRICHLET':
            ...
            raise ValueError("The method your entered does not exist or is not a few-shot method. Please check the spelling")
