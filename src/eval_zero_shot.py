...
from src.datasets import Tasks_Generator_zero_shot, SamplerQuery_zero_shot, CategoriesSampler_zero_shot, build_data_loader
    ...
    def evaluate_tasks(self, model, all_features_query, all_labels_query):
        ...
        for i in range(int(self.args.number_tasks/self.args.batch_size)):
            ...
            sampler = CategoriesSampler_zero_shot(self.args.batch_size,
                                    self.args.k_eff, self.args.n_ways, self.args.n_query, force_query_size=True)
