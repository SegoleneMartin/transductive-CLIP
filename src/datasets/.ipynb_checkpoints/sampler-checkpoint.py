...
class CategoriesSampler():
    ...
    def __init__(self, label_support, label_query, n_batch, k_eff, n_ways, s_shot, n_query, sampling, dataset_stanford=False):
        ...
        self.n_ways = n_ways
        self.dataset_stanford = dataset_stanford
...
class SamplerQuery:
    def __init__(self, cat_samp):
        ...
        self.dataset_stanford = cat_samp.dataset_stanford
