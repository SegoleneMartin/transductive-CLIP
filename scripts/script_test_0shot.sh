...
do
python main.py --opts batch_size 1000 number_tasks 1000 dataset ${dataset} shots ${s} n_query ${n_query} save_results True device ${device} seed 0 method ${method} used_test_set ${used_test_set} use_softmax_feature True
done
done
###
